...
if __name__ == '__main__':
    num_of_cards = 10000
    num_of_users = 7000
    card_to_user_map = {card_id: random.randint(0, num_of_users) for card_id in range(0, num_of_cards)}
    user_to_last_location_map = {user_id: rand_lat_long() for user_id in range(0, num_of_users)}
    card_to_limit_map = {card_id: np.abs(np.random.normal(20000, 40000)) for card_id in range(0, num_of_cards)}
